...
void CorrectionObject::L2ResAllRuns(){
  ...
  for(int j=0;j<5;j++){
    ...
    res_logpt_rel_kfsrfit->SetLineWidth(2);
    ...
    leg1.AddEntry(res_logpt_rel_kfsrfit,runnr,"L");
  ...
  TLegend leg2 = tdrLeg(0.40,0.19,0.65,0.4);

  TLine *line2 = new TLine(0,1,5.191,1);              
                            
  //  TString runnr_v[5]={"BCD","EFearly","FlateG","H", "BCDEFGH"};
  TCanvas* c4 = new TCanvas;
  tdrCanvas(c4,"c4",h1,4,10,true,"All Runs");
  TFile* f_Res_mpf;

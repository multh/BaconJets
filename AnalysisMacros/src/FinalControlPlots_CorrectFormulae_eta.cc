...
void CorrectionObject::FinalControlPlots_CorrectFormulae_eta(){
  ...
  for(int j=0; j<n_eta_control-1; j++){
     eta_cut_bool = fabs(eta_bins_control[j])>eta_cut;
      TString eta_name = "eta_"+eta_range_control2[j]+"_"+eta_range_control2[j+1];
  ...
  ofstream output;
  output.open(CorrectionObject::_outpath+"plots/control/Number_Events_Pt_eta_bins_control_"+CorrectionObject::_generator_tag+"_"+CorrectionObject::_jettag+ (abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "")  + ".txt");
  ...
  for(int i=0; i<n_pt-1; i++){
    ...
    for(int j=0; j<n_eta_control-1; j++){
      if(fabs(eta_bins_control[j])>eta_cut){
	output << " ....   - ";
	continue;
      }
  ...
  double val_rel_mc[n_eta_control-1][n_pt_-1]; //value at pt,eta
  double err_rel_mc[n_eta_control-1][n_pt_-1]; //error of ratio at pt,eta
  double val_mpf_mc[n_eta_control-1][n_pt_-1]; //ratio at pt,eta
  double err_mpf_mc[n_eta_control-1][n_pt_-1]; //error of ratio at pt,eta
  double val_rel_data[n_eta_control-1][n_pt_-1]; //value at pt,eta
  double err_rel_data[n_eta_control-1][n_pt_-1]; //error of ratio at pt,eta
  double val_mpf_data[n_eta_control-1][n_pt_-1]; //ratio at pt,eta
  double err_mpf_data[n_eta_control-1][n_pt_-1]; //error of ratio at pt,eta
  ...
  for(int i=0; i<n_eta_control-1; i++){
    ...
    c_mpf->SaveAs(CorrectionObject::_outpath+"plots/control/MPF_Response_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] + (abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
    ...
    c_rel->SaveAs(CorrectionObject::_outpath+"plots/control/Rel_Response_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
...
//*******************************************  Plot all Control Hists **************************
  ...
  for(int i=0; i<n_eta_control-1; i++){
    TString eta_name = "eta_"+eta_range_control2[i]+"_"+eta_range_control2[i+1];
    ...
    c1->SaveAs(CorrectionObject::_outpath+"plots/control/B_NormDistribution_MC_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
    ...
    c2->SaveAs(CorrectionObject::_outpath+"plots/control/B_NormDistribution_DATA_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
    ...
    c3->SaveAs(CorrectionObject::_outpath+"plots/control/A_NormDistribution_MC_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "")  + ".pdf");
    ...
    if(plot_full_A){
      for(int j=0; j<( eta_cut_bool ?  n_pt_HF-1 : n_pt-1 ); j++){
		...
		cFullA->SaveAs(CorrectionObject::_outpath+"plots/control/fullAsym/A_DATA_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1]+"_pt_"+ (eta_cut_bool?pt_range_HF:pt_range)[j] + "_" + (eta_cut_bool?pt_range_HF:pt_range)[j+1] +(abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
		delete cFullA;
   ...
   gPad->SetLogy();
    ...
    tex->DrawLatex(0.47,0.85,"Data, " + text);
    //tex_lumi->DrawLatex(0.50,0.91,CorrectionObject::_lumitag+"(13TeV)");
    c4->SaveAs(CorrectionObject::_outpath+"plots/control/A_NormDistribution_DATA_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");    
    ...
    tex->DrawLatex(0.47,0.85,"MC, " + text);
    //tex_lumi->DrawLatex(0.6,0.91,"MC");
    c5->SaveAs(CorrectionObject::_outpath+"plots/control/METoverPt_MC_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
   ...
   TCanvas* c6 = new TCanvas();
    ...
    tex->DrawLatex(0.47,0.85,"Data, " + text);
    //tex_lumi->DrawLatex(0.50,0.91,CorrectionObject::_lumitag+"(13TeV)");
    c6->SaveAs(CorrectionObject::_outpath+"plots/control/METoverPt_DATA_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] + (abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") +".pdf");    
...
//************************* Different energy fractions *****************************************
    ...
    leg7.Draw();
    tex->DrawLatex(0.47,0.85,"MC, " + text);
    c7->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_neutEmEF_MC_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
    ...
    leg8.Draw();
    tex->DrawLatex(0.47,0.85,"Data, " + text);
    c8->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_neutEmEF_DATA_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
    ...
    leg9.Draw();
    tex->DrawLatex(0.47,0.85,"MC, " + text);
    c9->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_neutHadEF_MC_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] + (abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") +".pdf");
    ...
    leg10.Draw();
    tex->DrawLatex(0.47,0.85,"Data, " + text);
    c10->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_neutHadEF_DATA_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "")+ ".pdf");
    ...
    leg11.Draw();
    tex->DrawLatex(0.47,0.85,"MC, " + text);
    c11->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_chEmEF_MC_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
    ...
    leg12.Draw();
    tex->DrawLatex(0.47,0.85,"Data, " + text);
    c12->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_chEmEF_DATA_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
    ...
    leg13.Draw();
    tex->DrawLatex(0.47,0.85,"MC, " + text);
    c13->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_chHadEF_MC_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] + (abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") +".pdf");
    ...
    leg14.Draw();
    tex->DrawLatex(0.47,0.85,"Data, " + text);
    c14->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_chHadEF_DATA_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] + (abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") +".pdf");
    ...
    leg15.Draw();
    tex->DrawLatex(0.47,0.85,"MC, " + text);
    c15->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_photonEF_MC_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] + (abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") +".pdf");
    ...
    leg16.Draw();
    tex->DrawLatex(0.47,0.85,"Data, " + text);
    c16->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_photonEF_DATA_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
  ...
  TCanvas* c17 = new TCanvas();
    ...
    leg17.Draw();
    tex->DrawLatex(0.47,0.85,"MC, " + text);
    c17->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_muonEF_MC_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] + (abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") +".pdf");
    ...
    leg18.Draw();
    tex->DrawLatex(0.47,0.85,"Data, " + text);
    c18->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_muonEF_DATA_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":""+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "")) + ".pdf");
    ...
    leg19.Draw();
    tex->DrawLatex(0.47,0.85,"MC, " + text);
    c19->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_phi_MC_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
    ...
    leg20.Draw();
    tex->DrawLatex(0.47,0.85,"Data, " + text);
    c20->SaveAs(CorrectionObject::_outpath+"plots/control/probejet_phi_DATA_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");
  ...
  for(int i=0; i<n_eta_control-1; i++){
    ...
    c1->SaveAs(CorrectionObject::_outpath+"plots/control/Pt_ave_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");    
 ...
 TCanvas* c2 = new TCanvas();
    ...
    c2->SaveAs(CorrectionObject::_outpath+"plots/control/MET_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] + (abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") +".pdf");    
 ...
 TCanvas* c3 = new TCanvas();
    ...
    c3->SaveAs(CorrectionObject::_outpath+"plots/control/alpha_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"")+ (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "") + ".pdf");    
...
TCanvas* c4 = new TCanvas();
    ...
    c4->SaveAs(CorrectionObject::_outpath+"plots/control/jet3_pt_" + CorrectionObject::_generator_tag + "_eta_" + eta_range_control2[i] + "_" + eta_range_control2[i+1] +(abs_asymmetry_cut ? "_wAsymCut":"") + (lumi_bin>=0 ? "_lumiBin" + to_string(lumi_bin)  : "")+ ".pdf");    

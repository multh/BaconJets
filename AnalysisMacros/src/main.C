...
TString input_path    = "/nfs/dust/cms/user/multh/JEC/2016ReReco/ClosureTest/Summer16_23Sep2016_V6/" + collection + "/MC_Reweighted_corMET/";
  TString weight_path = "/nfs/dust/cms/user/multh/JEC/2016ReReco/ClosureTest/Summer16_23Sep2016_V6/" + collection + "/MC_Reweighted_corMET_ForWeights/";  //Check Path for Weights 

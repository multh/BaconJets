...
private:
 ...
 const double pt_bins[11]={51, 73, 95, 163, 230, 299, 365, 453, 566, 1000, 2000};

 const TString pt_range_HF[8]= {"72", "95", "118", "188", "257", "354", "1000", "2000"};
 const double pt_bin_HF[8]={72, 95, 118, 188, 257, 354, 1000, 2000};

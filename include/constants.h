...
// static std::vector<double>   eta_range  = {2.964, 3.139, 3.489, 5.191}; //for HF triggers use
...
// static std::vector<double>   pt_range   = {77, 131, 154, 244, 321, 426}; //2.11 HF triggers
static int n_pt_bins = 9; //6 for HF; 9 for Nominal
...
/** \brief pt-bins corresponds for the 2015  2.11/fb  25ns data **/
///Asympt MC
static float scale_factor_noJERA[] = {3134.9, 10969, 10001.3, 27387.8, 468903, 672528, 4.17038e+06, 1.44398e+07, 1.7089e+07};//run2 69000 V6 Asym 60for80only 2
static float scale_factor_centrA[] = {2981.98,10586.7,9820.56,27160.5,464409,667504,4.1411e+06,1.4364e+07,1.69089e+07};//run2 69000 V6, cent.smear Asym 60for80only 2
static float scale_factor_upA[] = {2874.51, 10396.2, 9712.4, 27018.3, 462895, 665397, 4.1283e+06, 1.43384e+07, 1.68405e+07};//run2 69000 V6, up.smear Asym 60for80only 2
static float scale_factor_downA[] = {3075.04, 10785.2, 9907.87, 27249.6, 466336, 669405, 4.15346e+06, 1.43899e+07, 1.69864e+07};//run2 69000 V6, down.smear Asym 60for80only 2
static float scale_factor_centrA_PU80[] = {3370.87, 11363.8, 10277, 28299, 483457, 693496, 4.28772e+06, 1.4921e+07, 1.76017e+07};//run2 80000 V6, cent.smear Asym 60for80only 2
// static float scale_factor_centrA[] = {656.891,795.412,2805.58,50533.7,117209,22367.6};//run2 69000 V6, cent.smear Asym for HF

static float scale_factor_centrA_PU69_set1[] = {1111.78, 2969.16, 2753.22, 3888.24, 69284.6, 99612, 612942, 1.89654e+06, 1.81834e+06};//69mb V6, cent. Asym set1
static float scale_factor_centrA_PU69_set2[] = {423.303, 1591.85, 1484.52, 2697.94,  63826.9, 91486.2, 542606, 1.97481e+06, 1.91547e+06};//69mb V6, cent. Asym set2
static float scale_factor_centrA_PU69_set3[] = {379.129, 1482.2, 1349.83, 2584.28, 58697.6, 87290.4, 519621, 2.02811e+06, 1.96579e+06};//69mb V6, cent. Asym set3
static float scale_factor_centrA_PU69_set4[] = {299.906, 1204.09, 1100, 2338.59, 52135.2, 74471.4, 448186, 1.7772e+06, 1.72785e+06};//69mb V6, cent. Asym set4
static float scale_factor_centrA_PU69_set5[] = {189.08, 793.597, 736.411, 1947.83, 45077.2, 65552.7, 405774, 1.50256e+06, 1.74423e+06};//69mb V6, cent. Asym set5
static float scale_factor_centrA_PU69_set6[] = {113.619, 525.601, 494.17, 2271.52, 40197.2, 57013.3, 377918, 1.14571e+06, 1.83863e+06};//69mb V6, cent. Asym set6
static float scale_factor_centrA_PU69_set7[] = {260.853, 1005.81, 970.333, 4190.05, 49901.1, 69802.7, 435178, 1.39686e+06, 1.66173e+06};//69mb V6, cent. Asym set7
static float scale_factor_centrA_PU69_set8[] = {125.985, 587.013, 536.037, 4058.73, 46458.6, 66212.6, 435145, 1.46986e+06, 2.15342e+06};//69mb V6, cent. Asym set8
static float scale_factor_centrA_PU69_set9[] = {78.3287, 427.348, 396.04, 3183.31, 38830.2, 56062.8, 363732, 1.17238e+06, 2.0834e+06};//69mb V6, cent. Asym set9



///Flat MC
static float scale_factor_noJERF[] = {2520.98, 9041.37, 8321.97, 22310.1, 385342, 550228, 3.42556e+06, 1.17565e+07, 1.41959e+07};//run2 69000 V6 Flat 60for80only 2
static float scale_factor_centrF[] = {2393.91, 8738.02, 8138.46, 22131.8, 382407, 544738, 3.39795e+06, 1.17061e+07, 1.40886e+07};//run2 69000 V6, cent.smear Flat 60for80only 2



/** \brief pt-bins corresponds for the 2015  40/pb  50ns data **/
///Asympt MC
